...
public class HostServiceImpl implements HostService {
	...
	@Override
	public Host updateHost(Integer hostId, String name, String publicTel, String email, String intro,
		...
		if (host != null) {
			if (name != null)
				host.setName(name);
			if (publicTel != null)
				host.setPublicTel(publicTel);
			if (email != null)
				host.setEmail(email);
			if (intro != null)
				host.setIntro(intro);
			if (profile != null)
				host.setProfile(profile.getOriginalFilename());
		}
		if (profile != null && !profile.isEmpty()) {
	...
	public Host updateHostSettlement(Integer hostId, String bankName, String accName, String accNum,
		...
		if (host != null) {
			...
			if (accName != null)
				host.setAccName(accName);
			if (accNum != null)
				host.setAccNum(accNum);
			if (idCard != null)
				host.setIdCard(idCard.getOriginalFilename());
		}
