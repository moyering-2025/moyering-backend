...
@Entity
@EntityListeners(AuditingEntityListener.class) // 생성, 수정일자 자동 관리
...
public class Report {
    ...
    @Column(name = "targetOwner_id", nullable = false)
    ...
    // 생성에 필요한 최소한의 정보
    @Builder
    private Report(String reporterId, String targetId, String targetOwnerId, String title, String content, ReportType reportType){
